...
```typescript
import { getTransformersWorker, destroyTransformersWorker } from '@/utils/web-worker/transformers-worker';
```
...
更多任务类型请参考 [@xenova/transformers 文档](https://huggingface.co/docs/transformers.js/index)。
