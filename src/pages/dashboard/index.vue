...
import SaleroomView from './components/saleroom-view.vue';
import AccessSourceView from './components/access-source-view.vue';
import AreaRankingView from './components/area-ranking-view.vue';
