<template>
	<div class="data-screen-container">
		<div ref="dataScreenRef" class="data-screen">
			...
			<div class="data-screen-main">
				...
				<div class="data-screen-ct">
					<div class="data-screen-map">
						<div class="data-screen-map-title">景区实时客流量</div>
						<!-- <vue3-seamless-scroll
							:list="alarmData"
							class="data-screen-alarm"
							:step="0.5"
							:hover="true"
							:limitScrollNum="3"
						>
							<div class="data-screen-alarm">
...
import mapChart from './components/china-map-chart.vue';
import AgeRatioChart from './components/age-ratio-chart.vue';
import AnnualUseChart from './components/annual-use-chart.vue';
import HotPlateChart from './components/hot-plate-chart.vue';
import MaleFemaleRatioChart from './components/male-female-ratio-chart.vue';
import OverNext30Chart from './components/over-next30-chart.vue';
import PlatformSourceChart from './components/platform-source-chart.vue';
import RealTimeAccessChart from './components/real-time-access-chart.vue';
